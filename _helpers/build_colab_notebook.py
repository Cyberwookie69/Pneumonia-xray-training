...
CELLS = [
    ...
    code(
        ...
        "    # Clinical-usability minimum and theoretical-ceiling reference lines.\n"
        "    ax.axhline(0.90, linestyle='--', color='#D93025', alpha=0.6, linewidth=1.2,\n"
        "               label='Clinical-usability minimum (≥0.90)')\n"
        "    ax.axhline(0.95, linestyle='--', color='#33691E', alpha=0.6, linewidth=1.2,\n"
        "               label='Theoretical ceiling (~0.95)')\n"
